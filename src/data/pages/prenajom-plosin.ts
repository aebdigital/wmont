...
export const liftProducts: LiftProduct[] = [
  {
    ...
    specs: [
      { label: "Pracovná výška", value: "15,90 m" },
      { label: "Výška dna koša", value: "14,07 m" },
      { label: "Maximálny dosah", value: "7,64 m" },
      { label: "Výška pri max. horizontálnom výsuve", value: "7,37 m" },
      { label: "Maximálna nosnosť", value: "227 kg" },
      { label: "Dĺžka / Zložený stav", value: "6,83 m" },
      { label: "Šírka", value: "2,29 m" },
      { label: "Výška / Zložený stav", value: "2,11 m" },
      { label: "Čistá hmotnosť", value: "6 689 kg" },
      { label: "Pohon", value: "Diesel" },
      { label: "Priľnavosť", value: "45 %" },
    ],
  },
  {
